...
MAIN PROC
    ...
    LEA DX, NOMES + BX          ;APONTA PARA NOMES + BX (BX INDICA QUAL NOME IRA RECEBER(1º, 2º 3º...))
    CALL RECEBE_NOME
...
ENTNOTAS PROC
    ...
    ;DEVOLVE BX COM O VALOR DIGITADO PRA MAIN
        PUSH CX
        PUSH BX
        MOV CX, 3                                   ;RECEBERA 3 NOTAS
        LEA BX, NOMES + 34                          ;APENAS PARA INICIAR SI NO ELEMENTO CORRETO
